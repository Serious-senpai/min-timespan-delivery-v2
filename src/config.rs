...
pub struct Config {
    ...
    pub adaptive_dynamic_iterations: bool,
    ...
    pub fix_adaptive_segments: Option<usize>,
    pub fix_nonimp_segments: bool,
...
impl From<SerializedConfig> for Config {
    fn from(config: SerializedConfig) -> Self {
        ...
        Self {
            ...
            adaptive_dynamic_iterations: config.adaptive_dynamic_iterations,
            ...
            fix_adaptive_segments: config.fix_adaptive_segments,
            fix_nonimp_segments: config.fix_nonimp_segments,
